...
var createFilesFromTemplates = function (config, templatesDir, buildDir, callback) {
  ...
  async.waterfall([
    ...
    function (readCallback) {
      fs.readdir(templatesDir, readCallback);
    },
  ...
  function replaceAndWriteFile (filename, callback) {
    ...
    async.waterfall([
      ...
      function (newFileContents, writeCallback) {
        ...
        var writeFilename = path.join(buildDir, path.basename(filename));
